...
execute if score @a[team=Orange,limit=1] deaths matches 1 run title @a subtitle ["",{"text":"Good game ","color":"gold"},{"selector":"@s","color":"gold"}]
...
execute if score @a[team=Green,limit=1] deaths matches 1 run title @a subtitle ["",{"text":"Good game ","color":"green"},{"selector":"@s","color":"green"}]
